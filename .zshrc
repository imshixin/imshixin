...
then
	read -k 1 "str?source local_setup.bash(default y / n)? "
	echo "\r"
	if [ -n $str ]
	then
		if [ $str = 'y' -o $str = 'Y' ]
...
# zsh-completions zsh-autosuggestions zsh-syntax-highlighting need to be manually install
...
# for lubancat zeroN temperature
